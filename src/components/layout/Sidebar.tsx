...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { category: "GESTION DES STOCKS", path: '/inventory', icon: Boxes, label: 'Inventaire' },
    { path: '/traceability', icon: FileText, label: 'Traçabilité' },
    { path: '/quality', icon: Package, label: 'Qualité' },
    { category: "COMMERCIAL", path: '/suppliers', icon: ShoppingCart, label: 'Fournisseurs' },
    { path: '/clients', icon: Users, label: 'Clients' },
    { path: '/orders', icon: Package, label: 'Commandes' },
    { category: "ADMINISTRATION", path: '/analytics', icon: BarChart2, label: 'Analyses' },
    { path: '/company', icon: Building2, label: 'Entreprise' },
    { category: "PARAMETRES", path: '/settings', icon: Wrench, label: 'Configuration' },
  ];
