  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
          ...
          <div className="h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="absolute top-1 right-1 w-2 h-2 bg-[#E5A55D] rounded-full" />
              </motion.button>
      ...
      <main className="relative">
        <div className="absolute inset-0 bg-gradient-to-br from-[#E5A55D]/5 via-[#1A1A24]/5 to-transparent" />
