...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      "overflow-hidden rounded-md border border-white/10 p-6",
      "bg-gradient-to-br from-brand-dark/95 to-brand-purple/95 pr-8",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "border-white/10 bg-transparent px-3 text-sm font-medium",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "hover:text-white focus:opacity-100 focus:outline-none focus:ring-2",
