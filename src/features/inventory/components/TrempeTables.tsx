...
export const TrempeTables: React.FC<TrempeTablesProps> = ({
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-2 text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
        <Droplets size={28} className="text-cyan-400" />
        <h2>Tables de trempe</h2>
      </div>
