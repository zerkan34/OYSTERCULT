...
const typeColors = {
  movement: 'bg-emerald-400/20 text-emerald-300',
  treatment: 'bg-emerald-500/20 text-emerald-300',
  quality_check: 'bg-emerald-600/20 text-emerald-300',
  alert: 'bg-emerald-700/20 text-emerald-300'
};
...
export function BatchHistory({ searchQuery }: BatchHistoryProps) {
  ...
  return (
    <div className="glass-effect rounded-xl overflow-hidden">
      <div className="p-6 border-b border-emerald-400/30">
