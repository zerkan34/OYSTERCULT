 ...
 */
final class Version20250307170046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory_products ADD expiry_date DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory_products DROP expiry_date, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
