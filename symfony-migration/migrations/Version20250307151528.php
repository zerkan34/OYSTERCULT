 ...
 */
final class Version20250307151528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory_products CHANGE updated_at updated_at DATETIME DEFAULT NULL');
